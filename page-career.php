            ...
            <div class=" bg-jhl-foreground mb-6 rounded-lg fade-up" data-scroll data-scroll-class="is-inview">
                ...
                <div class="relative w-full">
                    ...
                    <img src="<?php echo esc_url(get_jhl_field('benefit_5_image', $theme_uri . '/images/benefit-5.jpg')); ?>"
                        class="w-full h-[218px] 2xl:h-[268px] object-cover rounded-b-lg" alt="Benefit">
                </div>
            </div>
        </div>
                ...
                <div class="md:col-span-8  rounded-lg relative min-h-[400px] vacancy-text fade-left" data-scroll
                    ...
                    <?php foreach ($vacancies as $index => $vacancy):
                        ...
                        <div id="vacancy-<?php echo $vacancy->ID; ?>" class="vacancy-content"
                            ...
                            <a href="mailto:<?php echo esc_url(get_jhl_field('email_apply', 'recruitment.jhlauto@gmail.com')) ?>?subject=Application for <?php echo urlencode(get_the_title($vacancy->ID)); ?>"
