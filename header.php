...
<body <?php body_class('bg-white text-zinc-900 antialiased'); ?>>
    ...
    <div id="page" class="min-h-screen flex flex-col">
        ...
        <header
            class="fixed z-40 top-4 left-1/2 -translate-x-1/2 container flex items-center justify-between text-white rounded-full py-[11px] px-[35px] isolate">
            ...
            <div>
                <nav>
                    <ul class="flex items-center space-x-10 text-sm font-medium">
                        ...
                        <li>
                            <a href="/news" class="uppercase text-[13px] font-medium !no-underline">News & Promotion</a>
                        </li>
                    </ul>
                </nav>
            </div>
            <div>
                <a href="#" class="text-[13px] font-medium flex items-center !no-underline space-x-1">
                    <img src="<?php echo get_template_directory_uri() ?>/images/icon-contact.png" class="size-3" alt="">
                    <span>Contact</span>
                </a>
            </div>
        </header>
